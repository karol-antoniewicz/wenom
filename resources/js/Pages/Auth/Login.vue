            ...
            <template #main>
                <div id="component">
                    ...
                    <div id="buttons">
                        ...
                        <SvwsUiButton @click="requestPassword()" type="secondary">Passwort anfordern</SvwsUiButton>
                    </div>
                </div>
            </template>
        </AuthLayout>
...
<style scoped>
    #logo {
        @apply flex gap-6 justify-start items-center
    }
