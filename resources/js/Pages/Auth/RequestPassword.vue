        ...
        <AuthLayout>
            <template #main>
                <div id="component">
                    ...
                    <div v-if="data.successMessage">
                        <div id="status">
                            <strong>Hinweis:</strong> <br>
                            Ihre Eingaben wurden empfangen. Wenn wir ein Konto haben, das Ihrer E-Mail-Adresse entspricht,
                            erhalten Sie eine E-Mail mit einem Link, um Ihr Passwort zu setzen.
                        </div>

                        <SvwsUiButton @click="navigate('login')">zum Login</SvwsUiButton>
                    </div>
                    ...
                    <div class="form-control-area" v-if="!data.successMessage">
                        ...
                        <div id="buttons">
                            <SvwsUiButton @click="submit()" :disabled="data.processing" class="self-start">Link zusenden
                            </SvwsUiButton>
                        </div>
                    </div>
                </div>
