            ...
            <template #main>
                <div id="component">
                    ...
                    <div class="form-control-area" v-if="!data.successMessage">
                        <h1 class="headline-1">WeNoM</h1>
                        <h2 class="headline-1">Zwei-Faktor Authentifizierung</h2>
                        <br>
                        <div class="form-control">
                        <div>
                            Bitte geben Sie Ihren zweiten Faktor an, der Ihnen per mail gesendet wurde.
                        </div>
                        <br>
                        ...
                        <br>
                        <div id="buttons">
                            <SvwsUiButton @click="submit()" :disabled="data.processing" class="self-start">Absenden
                            </SvwsUiButton>
                        </div>
                    </div>
                </div>
