        ...
        <AuthLayout>
            <template #main>
                <div id="component">
                    ...
                    <div class="form-control-area" v-if="!data.successMessage">
                        <h2 class="headline-4">Sicherheitsüberprüfung</h2>
                        <p>
                            Bitte geben Sie den OTP-Code ein, den Sie per E-Mail erhalten haben.
                            Überprüfen Sie Ihr E-Mail-Postfach und kopieren Sie den Code in das Feld unten.
                        ...
                        <div id="buttons">
                            <SvwsUiButton @click="submit()" :disabled="data.processing" class="self-start">
                                Bestätigen
                            </SvwsUiButton>
                            <SvwsUiButton @click="logout()">
                                Abmelden
                            </SvwsUiButton>
                        </div>
                    </div>
...
<script setup lang="ts">
    ...
    const submit = (): void => 
    Inertia.post(route('otp.verify'), data.form, {
